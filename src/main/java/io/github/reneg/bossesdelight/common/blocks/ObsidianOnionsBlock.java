...
public class ObsidianOnionsBlock extends CropBlock {
    ...
    public ObsidianOnionsBlock(Properties properties) {
        super(properties);
    }

    public BlockState getPlant(BlockGetter world, BlockPos pos) {
        return (BossesDelightBlock.OBSIDIAN_ONION_BLOCK.get()).defaultBlockState();
    }

    protected ItemLike getBaseSeedId() {
        return BossesDelightItems.OBSIDIAN_ONION.get();
    }
    ...
    public void randomTick(BlockState p_221050_, ServerLevel p_221051_, BlockPos p_221052_, RandomSource p_221053_) {
        if (p_221051_.isAreaLoaded(p_221052_, 1)) {
            ...
            if (i < this.getMaxAge()) {
                ...
                if (CommonHooks.canCropGrow(p_221051_, p_221052_, p_221050_, p_221053_.nextInt((int)(25.0F / f) + 1) == 0)) {
