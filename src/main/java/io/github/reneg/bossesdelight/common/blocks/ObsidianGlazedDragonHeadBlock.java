...
public class ObsidianGlazedDragonHeadBlock extends FeastBlock {
    ...
    public ObsidianGlazedDragonHeadBlock(Properties properties, Supplier<Item> servingItem, boolean hasLeftovers) {
